// class vehicle {
//     constructor(name,color,model,topspeed){
//         this.name = name;
//         this.color = color;
//         this.model = model;
//         this.speed = topspeed;
//         this.currentspeed = 0;
//     }
//     zeroToSixty = (callback) => {
//         setTimeout(() => {
//             console.log("just drove with this speed");
...
//     }
//     drive() {
//         console.log("just drove and the top speed was , now driving at the speed of")
...
// const ferrair = new vehicle("fai","red","34x23","23kph");
// const mile = new vehicle("mile","red","3bf53",250)
// // console.log(ferrair);
// // ferrair.drive();
// // ferrair.zeroToSixty(ferrair.drive)
// mile.drive();
// mile.zeroToSixty(mile.drive)
// console.log(mile.model);
...
class Player {
  ...
  strike (player, enemy, attackDmg) {
    const ran = Math.floor(Math.random()*this.attackDmg)
    console.log(ran);
